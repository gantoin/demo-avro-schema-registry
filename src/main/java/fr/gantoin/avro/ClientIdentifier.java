...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3174877322482146478L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"fr.gantoin.avro\",\"fields\":[{\"name\":\"hostname\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   */
  public static fr.gantoin.avro.ClientIdentifier.Builder newBuilder() {
    return new fr.gantoin.avro.ClientIdentifier.Builder();
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static fr.gantoin.avro.ClientIdentifier.Builder newBuilder(fr.gantoin.avro.ClientIdentifier.Builder other) {
    return new fr.gantoin.avro.ClientIdentifier.Builder(other);
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static fr.gantoin.avro.ClientIdentifier.Builder newBuilder(fr.gantoin.avro.ClientIdentifier other) {
    return new fr.gantoin.avro.ClientIdentifier.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(fr.gantoin.avro.ClientIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(fr.gantoin.avro.ClientIdentifier other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostname)) {
        this.hostname = data().deepCopy(fields()[0].schema(), other.hostname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.ClientIdentifier.Builder setHostname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.ClientIdentifier.Builder clearHostname() {
      hostname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.ClientIdentifier.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.ClientIdentifier.Builder clearIpAddress() {
      ipAddress = null;
