...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public fr.gantoin.avro.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<java.lang.CharSequence> employeeNames;
  @Deprecated public fr.gantoin.avro.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, fr.gantoin.avro.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, fr.gantoin.avro.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (fr.gantoin.avro.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (fr.gantoin.avro.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public fr.gantoin.avro.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(fr.gantoin.avro.ClientIdentifier value) {
   ...
   */
  public fr.gantoin.avro.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(fr.gantoin.avro.Active value) {
    this.active = value;
  }
   ...
   */
  public static fr.gantoin.avro.AvroHttpRequest.Builder newBuilder() {
    return new fr.gantoin.avro.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static fr.gantoin.avro.AvroHttpRequest.Builder newBuilder(fr.gantoin.avro.AvroHttpRequest.Builder other) {
    return new fr.gantoin.avro.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static fr.gantoin.avro.AvroHttpRequest.Builder newBuilder(fr.gantoin.avro.AvroHttpRequest other) {
    return new fr.gantoin.avro.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private fr.gantoin.avro.ClientIdentifier clientIdentifier;
    private fr.gantoin.avro.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private fr.gantoin.avro.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(fr.gantoin.avro.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = fr.gantoin.avro.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(fr.gantoin.avro.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder setClientIdentifier(fr.gantoin.avro.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public fr.gantoin.avro.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(fr.gantoin.avro.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(fr.gantoin.avro.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public fr.gantoin.avro.AvroHttpRequest.Builder setClientIdentifierBuilder(fr.gantoin.avro.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder setActive(fr.gantoin.avro.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.gantoin.avro.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (fr.gantoin.avro.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (fr.gantoin.avro.Active) defaultValue(fields()[3]);
        return record;
